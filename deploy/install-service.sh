...
echo ""
echo "To enable automatic push-to-deploy (no LAN access needed for future"
echo "deploys), also run: ./deploy/install-runner.sh --host ${HOST} --label beamrider-0003 --token <REG_TOKEN>"
